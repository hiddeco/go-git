...
func NewPackfileIter(
	...
	ph := packhandle.New(packhandle.Sources{
		...
		Idx:  packhandle.Source{Open: func() (billy.ReaderAtCloser, error) { return nil, idxErr }, Size: func() (int64, error) { return 0, idxErr }},
		Rev:  packhandle.Source{Open: func() (billy.ReaderAtCloser, error) { return nil, revErr }, Size: func() (int64, error) { return 0, revErr }},
	})
