...
// (compat/mingw.c L3363-L3366, tag v2.54.0), over every component in
// a closed corpus. A table of hand-picked rows catches a wrong
// verdict; only this catches a subtly wrong port.
